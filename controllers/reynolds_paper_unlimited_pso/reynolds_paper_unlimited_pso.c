 ...
 * CONTROL PARAMETERS
 */
double COEF_KP;    // proportional gain for the angular velocity controller
double COEF_B;    // gain on the virtual force
double COEF_R;    // gain on the migration urge
double COEF_S;    // gain on the cohesion
double COEF_T;    // Threshold
